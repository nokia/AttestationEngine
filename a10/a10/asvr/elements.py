...
def addElement(e):
	...
	if r==True:
		a10.asvr.db.announce.announceItemManagement("add",{"type":"element","itemid":i})
		return a10.structures.returncode.ReturnCode( a10.structures.constants.SUCCESS, i )
	else:
		return a10.structures.returncode.ReturnCode( a10.structures.constants.ADDITEMFAIL, "Element not added to database" )
...
def updateElement(e):
	...
	if r==True:
		a10.asvr.db.announce.announceItemManagement("update",{"type":"element","itemid":e['itemid']})
		return a10.structures.returncode.ReturnCode( a10.structures.constants.SUCCESS, "Element updated" )
	else:
...
def deleteElement(i):
	...
	if e is True:
		a10.asvr.db.announce.announceItemManagement("delete",{"type":"element","itemid":i})
		return a10.structures.returncode.ReturnCode( a10.structures.constants.SUCCESS,e)
	else:

...
def addResult(e):
	...
	if (r==True):
		a10.asvr.db.announce.announceResult("add",{"type":"result","itemid":i,"result":e["result"]})        
		return a10.structures.returncode.ReturnCode( a10.structures.constants.SUCCESS, i )
	else:
		return a10.structures.returncode.ReturnCode( a10.structures.constants.ADDITEMFAIL, "Result not added to database" )

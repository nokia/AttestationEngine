...
class AlwaysSuccess(baserule.BaseRule):
	...
	def __init__(self, cid, ps):
		...
		self.description = "Always success null rule. This return always returns SUCCESS"

	def apply(self):
		return self.returnMessage(  a10.structures.constants.VERIFYSUCCEED, 
...
class AlwaysFail(baserule.BaseRule):
	...
	def apply(self):
	   	return self.returnMessage(  a10.structures.constants.VERIFYFAIL, 
...
class AlwaysError(baserule.BaseRule):
	...
	def apply(self):
	   	return self.returnMessage(  a10.structures.constants.VERIFYERROR, 
...
class AlwaysNoResult(baserule.BaseRule):
	...
	def __init__(self, cid, ps):
		super().__init__(cid, ps)
		self.description = "Always no result null rule. This return always returns NORESULT"

	def apply(self):
	   	return self.returnMessage(  a10.structures.constants.VERIFYNORESULT, 

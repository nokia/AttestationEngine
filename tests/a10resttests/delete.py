...
curl   --header "Content-Type: application/json" -X POST --data '{  "ak_name": "XYZ",   "ak_pem": "QPR",   "asurl": "http://127.0.0.1:8510",   "description": "Local Machine .. asumed to be an x86 systems",   "ek_name": "DEF",   "ek_pem": "ABC",   "endpoint": "http://127.0.0.1:8530",  "name": "Locahost curl test",   "type": "tpm2.0"}' http://127.0.0.1:8520/element

...
e_convenience = a10.structures.convenience.TPM2Element("TestElement","This is a test element","http://127.0.0.1:8530","A10HTTPREST",
	                                      "ekpem","ekname","akpem","akname")
...
banner("Getting element - this should fail with a "+str(a10.structures.constants.ITEMDOESNOTEXIST)+" error code")
...
banner("Getting policy - this should fail with a "+str(a10.structures.constants.ITEMDOESNOTEXIST)+" error code")
...
banner("Getting expected value - this should fail with a "+str(a10.structures.constants.ITEMDOESNOTEXIST)+" error code")
...
c = {   "header" : { "as_requested":"1", "as_received":"1", "ta_received":"1", "ta_complete":"1","elementID":"1","policyID":"1"
                        },
        "payload": "the payload",
...
for i in range(1,10): 
	econv = a10.structures.convenience.TPM2Element("TestElement"+str(i),"This is a test element","http://127.0.0.1:8530","A10HTTPREST",
	                                      "ekpem","ekname","akpem","akname")

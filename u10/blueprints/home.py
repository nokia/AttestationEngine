...
def favicon():
    return send_from_directory(home_blueprint.static_folder, 'favicon.ico',
...
def hello():
    ...
    return render_template('home/home.html', d={'dbstatus': dbstatus, 'configuration': constatus}, release=release)

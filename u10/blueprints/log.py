...
log_blueprint = Blueprint('log', __name__, static_folder='../static', template_folder='../templates/')
...
def getlog():
	...
	return render_template('log.html', ls=ls, lrs=lrs, lc=lc, lt=ts, ltutc=formatting.futc(ts))

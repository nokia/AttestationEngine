...
rules_blueprint = Blueprint('rules', __name__, static_folder='../static', template_folder='../templates/')
...
def results():
    ...
    rsl = []
    for r in rs:
    	rsl.append( {"name":r,"description":a10.asvr.rules.rule_dispatcher.getRuleDescription(r).msg()})
